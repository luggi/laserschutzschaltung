// ======================================================================
// Laserschutzschaltung.v generated from TopDesign.cysch
// 05/29/2017 at 14:29
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0\not_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\not_v1_0\not_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif

// IDAC8_v2_0(Current=504, Data_Source=0, Hardware_Enable=false, IDAC_Range=8, IDAC_Speed=2, Initial_Value=63, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8_1, CY_INSTANCE_SHORT_NAME=IDAC8_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=IDAC8_1, )
module IDAC8_v2_0_0 (
    strobe,
    data,
    iOut,
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=0, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8, CY_INSTANCE_SHORT_NAME=VDAC8, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=VDAC8, )
...
// Comp_v2_0(Hysteresis=1, Pd_Override=0, Polarity=1, PSOC5A=false, Speed=1, Sync=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_2, CY_INSTANCE_SHORT_NAME=Comp_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=Comp_2, )
module Comp_v2_0_3 (
    Vplus,
    CmpOut,
    Vminus,
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0\or_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\or_v1_0\or_v1_0.v"
`endif

// Comp_v2_0(Hysteresis=1, Pd_Override=0, Polarity=1, PSOC5A=false, Speed=1, Sync=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_3, CY_INSTANCE_SHORT_NAME=Comp_3, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=Comp_3, )
module Comp_v2_0_5 (
    Vplus,
    CmpOut,
    Vminus,
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_analog_virtualmux_v1_0\cy_analog_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_vref_v1_60"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_vref_v1_60\cy_vref_v1_60.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_vref_v1_60"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_vref_v1_60\cy_vref_v1_60.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0\cy_constant_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_constant_v1_0\cy_constant_v1_0.v"
`endif

// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1200000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=ADC_SAR_1, )
...
// IDAC8_v2_0(Current=10, Data_Source=0, Hardware_Enable=false, IDAC_Range=0, IDAC_Speed=2, Initial_Value=80, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8_2, CY_INSTANCE_SHORT_NAME=IDAC8_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=IDAC8_2, )
module IDAC8_v2_0_9 (
    strobe,
    data,
    iOut,
...
// PGA_v2_0(Gain=0, Power=3, VddaValue=5, Vref_Input=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PGA_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_1, CY_INSTANCE_SHORT_NAME=PGA_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=PGA_1, )
module PGA_v2_0_10 (
    Vin,
    Vref,
    Vout);
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=3, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=48, CONTROL3=1, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InitCounterValue=4800, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=true, Period=4800, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_1, CY_INSTANCE_SHORT_NAME=Counter_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=Counter_1, )
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_srff_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_srff_v1_0\cy_srff_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_srff_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_srff_v1_0\cy_srff_v1_0.v"
`endif
...
// PGA_v2_0(Gain=0, Power=1, VddaValue=5, Vref_Input=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PGA_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_2, CY_INSTANCE_SHORT_NAME=PGA_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=PGA_2, )
module PGA_v2_0_14 (
    Vin,
    Vref,
    Vout);
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\ADC_AMUX_v2_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\ADC_AMUX_v2_0\ADC_AMUX_v2_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\ADC_AMUX_v2_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\ADC_AMUX_v2_0\ADC_AMUX_v2_0.v"
`endif

// ADC_SAR_v3_0(ADC_Clock=0, ADC_Clock_Frequency=10105264, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=true, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=true, Sample_Precharge=4, Sample_Rate=0, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq_2:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=ADC_SAR_Seq_2_SAR, )
module ADC_SAR_v3_0_15 (
    vplus,
    vminus,
    soc,
    eoc,
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bADC_SAR_SEQ_v2_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bADC_SAR_SEQ_v2_0\bADC_SAR_SEQ_v2_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bADC_SAR_SEQ_v2_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\bADC_SAR_SEQ_v2_0\bADC_SAR_SEQ_v2_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_sync_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_sync_v1_0\cy_sync_v1_0.v"
`else
`define CY_BLK_DIR "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_sync_v1_0"
`include "C:\Program Files\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_sync_v1_0\cy_sync_v1_0.v"
`endif

// ADC_SAR_SEQ_v2_0(ADC_Clock_Frequency=1600000, Adjust=0, ClockSource=0, InputRange=1, NumChannels=4, Reference=0, Resolution=12, rm_int=false, SampleMode=0, SamplePrecharge=4, SampleRate=100000, SampleRate_def=631579, VrefValue=2.5, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_Seq_2, CY_INSTANCE_SHORT_NAME=ADC_SAR_Seq_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=ADC_SAR_Seq_2, )
module ADC_SAR_SEQ_v2_0_16 (
    soc,
    aclk,
    sdone,
    eoc,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=10000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_2, CY_INSTANCE_SHORT_NAME=PWM_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=PWM_2, )
module PWM_v3_30_17 (
    reset,
    clock,
    tc,
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=1600, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_1, CY_INSTANCE_SHORT_NAME=VDAC8_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=VDAC8_1, )
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=1, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_4, CY_INSTANCE_SHORT_NAME=Comp_4, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=Comp_4, )
module Comp_v2_0_19 (
    Vplus,
    CmpOut,
    Vminus,
...
module top ;
    ...
    defparam IDAC8_1.Initial_Value = 63;
	...
	wire [0:0] tmpOE__Diode_Pumpseite_net;
	wire [0:0] tmpFB_0__Diode_Pumpseite_net;
	wire [0:0] tmpIO_0__Diode_Pumpseite_net;
	wire [0:0] tmpINTERRUPT_0__Diode_Pumpseite_net;
	electrical [0:0] tmpSIOVREF__Diode_Pumpseite_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  ...
		  .input_buffer_sel(2'b00))
		Diode_Pumpseite
		 (.oe(tmpOE__Diode_Pumpseite_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Diode_Pumpseite_net[0:0]}),
		  .analog({Net_558}),
		  .io({tmpIO_0__Diode_Pumpseite_net[0:0]}),
		  .siovref(tmpSIOVREF__Diode_Pumpseite_net),
		  .interrupt({tmpINTERRUPT_0__Diode_Pumpseite_net[0:0]}),
		  .annotation({Net_543}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Diode_Pumpseite_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_943 = Seed2 | Seed1 | Osc_err | Temp_err | Osc_err_low;
	...
	wire [0:0] tmpOE__Diode_Seedseite_net;
	wire [0:0] tmpFB_0__Diode_Seedseite_net;
	wire [0:0] tmpIO_0__Diode_Seedseite_net;
	wire [0:0] tmpINTERRUPT_0__Diode_Seedseite_net;
	electrical [0:0] tmpSIOVREF__Diode_Seedseite_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  ...
		  .input_buffer_sel(2'b00))
		Diode_Seedseite
		 (.oe(tmpOE__Diode_Seedseite_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Diode_Seedseite_net[0:0]}),
		  .analog({Net_91}),
		  .io({tmpIO_0__Diode_Seedseite_net[0:0]}),
		  .siovref(tmpSIOVREF__Diode_Seedseite_net),
		  .interrupt({tmpINTERRUPT_0__Diode_Seedseite_net[0:0]}),
		  .annotation({Net_548}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Diode_Seedseite_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Seed_ref_net;
	wire [0:0] tmpFB_0__Seed_ref_net;
	wire [0:0] tmpIO_0__Seed_ref_net;
	wire [0:0] tmpINTERRUPT_0__Seed_ref_net;
	electrical [0:0] tmpSIOVREF__Seed_ref_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("152a6a2e-04d1-4fd9-8247-e1e6823ea652"),
		  ...
		  .input_buffer_sel(2'b00))
		Seed_ref
		 (.oe(tmpOE__Seed_ref_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Seed_ref_net[0:0]}),
		  .analog({Net_93}),
		  .io({tmpIO_0__Seed_ref_net[0:0]}),
		  .siovref(tmpSIOVREF__Seed_ref_net),
		  .interrupt({tmpINTERRUPT_0__Seed_ref_net[0:0]}),
		  .annotation({Net_132}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Seed_ref_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pump_ref_net;
	wire [0:0] tmpFB_0__Pump_ref_net;
	wire [0:0] tmpIO_0__Pump_ref_net;
	wire [0:0] tmpINTERRUPT_0__Pump_ref_net;
	electrical [0:0] tmpSIOVREF__Pump_ref_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b3c1449f-ffb2-4921-8d53-12b19966cef2"),
		  ...
		  .input_buffer_sel(2'b00))
		Pump_ref
		 (.oe(tmpOE__Pump_ref_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pump_ref_net[0:0]}),
		  .analog({Net_69}),
		  .io({tmpIO_0__Pump_ref_net[0:0]}),
		  .siovref(tmpSIOVREF__Pump_ref_net),
		  .interrupt({tmpINTERRUPT_0__Pump_ref_net[0:0]}),
		  .annotation({Net_126}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pump_ref_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam R_3.comp_name = "Potentiometer_v1_0";
    defparam R_3.port_names = "T1, T2, W";
    defparam R_3.width = 3;
    ...
    cy_annotation_universal_v1_0 Power (
        .connect({
            Net_131
        })
    );
    defparam Power.comp_name = "Power_v1_0";
    defparam Power.port_names = "T1";
    defparam Power.width = 1;
    ...
    defparam IDAC8_2.Initial_Value = 80;
    defparam IDAC8_2.Strobe_Mode = 0;

	wire [0:0] tmpOE__DAC_PGA_OUT_net;
	wire [0:0] tmpFB_0__DAC_PGA_OUT_net;
	wire [0:0] tmpIO_0__DAC_PGA_OUT_net;
	wire [0:0] tmpINTERRUPT_0__DAC_PGA_OUT_net;
	electrical [0:0] tmpSIOVREF__DAC_PGA_OUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("481b718a-148e-48ce-a544-a38e0203045c"),
		  ...
		  .input_buffer_sel(2'b00))
		DAC_PGA_OUT
		 (.oe(tmpOE__DAC_PGA_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DAC_PGA_OUT_net[0:0]}),
		  .analog({Net_308}),
		  .io({tmpIO_0__DAC_PGA_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__DAC_PGA_OUT_net),
		  .interrupt({tmpINTERRUPT_0__DAC_PGA_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DAC_PGA_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__DAC_Current_net;
	wire [0:0] tmpFB_0__DAC_Current_net;
	wire [0:0] tmpIO_0__DAC_Current_net;
	wire [0:0] tmpINTERRUPT_0__DAC_Current_net;
	electrical [0:0] tmpSIOVREF__DAC_Current_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c6c834b0-2e80-4a5a-89b4-915a03a07cde"),
		  ...
		  .input_buffer_sel(2'b00))
		DAC_Current
		 (.oe(tmpOE__DAC_Current_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DAC_Current_net[0:0]}),
		  .analog({Net_302}),
		  .io({tmpIO_0__DAC_Current_net[0:0]}),
		  .siovref(tmpSIOVREF__DAC_Current_net),
		  .interrupt({tmpINTERRUPT_0__DAC_Current_net[0:0]}),
		  .annotation({Net_310}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__DAC_Current_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 R_IDAC (
        .connect({
            Net_310,
            Net_313
        })
    );
    defparam R_IDAC.comp_name = "Resistor_v1_0";
    defparam R_IDAC.port_names = "T1, T2";
    defparam R_IDAC.width = 2;
    ...
    ADC_DelSig_v3_20_12 ADC_DelSig_1 (
        .vplus(Net_412),
        .vminus(Net_413),
        .soc(1'b1),
        .eoc(Net_415),
	...
	wire [0:0] tmpOE__temp_sens_net;
	wire [0:0] tmpFB_0__temp_sens_net;
	wire [0:0] tmpIO_0__temp_sens_net;
	wire [0:0] tmpINTERRUPT_0__temp_sens_net;
	electrical [0:0] tmpSIOVREF__temp_sens_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("664f0f9b-2295-4c1f-9c97-703882660bc8"),
		  ...
		  .input_buffer_sel(2'b00))
		temp_sens
		 (.oe(tmpOE__temp_sens_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__temp_sens_net[0:0]}),
		  .analog({Net_412}),
		  .io({tmpIO_0__temp_sens_net[0:0]}),
		  .siovref(tmpSIOVREF__temp_sens_net),
		  .interrupt({tmpINTERRUPT_0__temp_sens_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__temp_sens_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- SRFF Start --
    reg  cy_srff_1;
    always @(posedge Net_52)
    begin
        cy_srff_1 <= (Net_943 | Net_465) & ~Net_795;
    end
    assign Net_465 = cy_srff_1;
    // -- SRFF End --
    ...
    CyControlReg_v1_80 Control_RS (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Control_RS.Bit0Mode = 0;
    defparam Control_RS.Bit1Mode = 0;
    defparam Control_RS.Bit2Mode = 0;
    defparam Control_RS.Bit3Mode = 0;
    defparam Control_RS.Bit4Mode = 0;
    defparam Control_RS.Bit5Mode = 0;
    defparam Control_RS.Bit6Mode = 0;
    defparam Control_RS.Bit7Mode = 0;
    defparam Control_RS.BitValue = 0;
    defparam Control_RS.BusDisplay = 0;
    defparam Control_RS.ExtrReset = 0;
    defparam Control_RS.NumOutputs = 2;

    USBFS_v3_10_13 USBUART_1 (
        .sof(Net_521),
        .vbusdet(Net_522));
    defparam USBUART_1.epDMAautoOptimization = 0;

	wire [0:0] tmpOE__VUSB_net;
	wire [0:0] tmpIO_0__VUSB_net;
	wire [0:0] tmpINTERRUPT_0__VUSB_net;
	electrical [0:0] tmpSIOVREF__VUSB_net;
	...
	cy_psoc3_pins_v1_10
		...
		VUSB
		 (.oe(tmpOE__VUSB_net),
		  .y({1'b0}),
		  .fb({Net_522}),
		  .io({tmpIO_0__VUSB_net[0:0]}),
		  .siovref(tmpSIOVREF__VUSB_net),
		  .interrupt({tmpINTERRUPT_0__VUSB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VUSB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyStatusReg_v1_90 Fault_Reg (
        ...
        .intr(Net_608),
        .status_bus(8'b0));
    defparam Fault_Reg.Bit0Mode = 0;
    defparam Fault_Reg.Bit1Mode = 0;
    defparam Fault_Reg.Bit2Mode = 0;
    defparam Fault_Reg.Bit3Mode = 0;
    defparam Fault_Reg.Bit4Mode = 0;
    defparam Fault_Reg.Bit5Mode = 0;
    defparam Fault_Reg.Bit6Mode = 0;
    defparam Fault_Reg.Bit7Mode = 0;
    defparam Fault_Reg.BusDisplay = 0;
    defparam Fault_Reg.Interrupt = 0;
    defparam Fault_Reg.MaskValue = 0;
    defparam Fault_Reg.NumInputs = 6;
    ...
    ADC_SAR_SEQ_v2_0_16 ADC_SAR_Seq_2 (
        .soc(1'b0),
        .aclk(1'b0),
        .sdone(Net_805),
        .eoc(Net_806),
	...
	wire [0:0] tmpOE__Curr_control_net;
	wire [0:0] tmpFB_0__Curr_control_net;
	wire [0:0] tmpIO_0__Curr_control_net;
	wire [0:0] tmpINTERRUPT_0__Curr_control_net;
	electrical [0:0] tmpSIOVREF__Curr_control_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("db5eb201-79c3-4e86-b540-a07c57bc430d"),
		  ...
		  .input_buffer_sel(2'b00))
		Curr_control
		 (.oe(tmpOE__Curr_control_net),
		  .y({Net_938}),
		  .fb({tmpFB_0__Curr_control_net[0:0]}),
		  .io({tmpIO_0__Curr_control_net[0:0]}),
		  .siovref(tmpSIOVREF__Curr_control_net),
		  .interrupt({tmpINTERRUPT_0__Curr_control_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Curr_control_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pump_diode_net;
	wire [0:0] tmpFB_0__pump_diode_net;
	wire [0:0] tmpIO_0__pump_diode_net;
	wire [0:0] tmpINTERRUPT_0__pump_diode_net;
	electrical [0:0] tmpSIOVREF__pump_diode_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		pump_diode
		 (.oe(tmpOE__pump_diode_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pump_diode_net[0:0]}),
		  .analog({Net_808}),
		  .io({tmpIO_0__pump_diode_net[0:0]}),
		  .siovref(tmpSIOVREF__pump_diode_net),
		  .interrupt({tmpINTERRUPT_0__pump_diode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pump_diode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__osc_diode_net;
	wire [0:0] tmpFB_0__osc_diode_net;
	wire [0:0] tmpIO_0__osc_diode_net;
	wire [0:0] tmpINTERRUPT_0__osc_diode_net;
	electrical [0:0] tmpSIOVREF__osc_diode_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("46d5e18b-bc81-4c15-975a-62e126123f14"),
		  ...
		  .input_buffer_sel(2'b00))
		osc_diode
		 (.oe(tmpOE__osc_diode_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__osc_diode_net[0:0]}),
		  .analog({Net_807}),
		  .io({tmpIO_0__osc_diode_net[0:0]}),
		  .siovref(tmpSIOVREF__osc_diode_net),
		  .interrupt({tmpINTERRUPT_0__osc_diode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__osc_diode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__seed_diode_net;
	wire [0:0] tmpFB_0__seed_diode_net;
	wire [0:0] tmpIO_0__seed_diode_net;
	wire [0:0] tmpINTERRUPT_0__seed_diode_net;
	electrical [0:0] tmpSIOVREF__seed_diode_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0780d0f3-c5a5-433f-a28c-67cb8c586061"),
		  ...
		  .input_buffer_sel(2'b00))
		seed_diode
		 (.oe(tmpOE__seed_diode_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__seed_diode_net[0:0]}),
		  .analog({Net_957}),
		  .io({tmpIO_0__seed_diode_net[0:0]}),
		  .siovref(tmpSIOVREF__seed_diode_net),
		  .interrupt({tmpINTERRUPT_0__seed_diode_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__seed_diode_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
