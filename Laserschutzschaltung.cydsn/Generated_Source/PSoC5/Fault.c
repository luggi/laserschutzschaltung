...
{
    uint8 staticBits = (Fault_DR & (uint8)(~Fault_MASK));
    Fault_DR = staticBits | ((uint8)(value << Fault_SHIFT) & Fault_MASK);
}
...
{
	CyPins_SetPinDriveMode(Fault_0, mode);
}
...
{
    return (Fault_PS & Fault_MASK) >> Fault_SHIFT;
}
...
{
    return (Fault_DR & Fault_MASK) >> Fault_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Fault_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Fault_0_INTR) != 0u) 
		{ 
			 Fault_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Fault_INTSTAT & Fault_MASK) >> Fault_SHIFT;
    }
