...
#if !(CY_PSOC5A &&\
	 LCD_Char_1_LCDPort__PORT == 15 && (LCD_Char_1_LCDPort__MASK & 0xC0))
...
{
    uint8 staticBits = LCD_Char_1_LCDPort_DR & ~LCD_Char_1_LCDPort_MASK;
    LCD_Char_1_LCDPort_DR = staticBits | ((value << LCD_Char_1_LCDPort_SHIFT) & LCD_Char_1_LCDPort_MASK);
}
